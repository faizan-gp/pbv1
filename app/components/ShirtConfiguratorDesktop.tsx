...
export default function ShirtConfiguratorDesktop({ product }: ShirtConfiguratorProps) {
    ...
    return (
        <div className="relative z-10 pt-24 pb-12 px-8 max-w-[1600px] mx-auto min-h-screen flex flex-row gap-6">
            ...
            <div className="flex-1 flex flex-col min-h-[calc(100vh-140px)]">
                ...
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-50 text-indigo-700 text-xs font-bold border border-indigo-100">
