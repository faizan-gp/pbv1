        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              (window, document, 'script', 'https://connect.facebook.net/en_US/fbevents.js', 'https://tracking.printbrawl.com/sdk/2144149738840324497/events.js');
              fbq('init', '1420495289671184');
              fbq('track', 'PageView');
              cbq('setHost', 'https://tracking.printbrawl.com');
              cbq('init', '2144149738840324497');
